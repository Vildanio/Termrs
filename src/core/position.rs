...
///
/// The position is relative to the top left corner of the buffer, with the top left corner
...
pub struct Position {
    ...
    ///
    /// The x coordinate is relative to the left edge of the buffer, with the left edge being 0.
    pub x: u16,

    /// The y coordinate of the position
    ///
    /// The y coordinate is relative to the top edge of the buffer, with the top edge being 0.
    pub y: u16,
}
